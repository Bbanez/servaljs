...
import { JWT, JWTSchema, JWTScope } from './models';
...
export class JWTManager {
  ...
  static validate<PayloadProps = undefined>(
    ...
    const checkObject = ObjectUtility.compareWithSchema(jwt, JWTSchema, 'jwt');
  ...
  static get<PayloadProps = undefined>(
    ...
    if (jwt instanceof Error) {
      ...
      const jwtValid = JWTManager.validateAndCheckPermissions<PayloadProps>({
        jwt,
        roles: data.roles,
      });
